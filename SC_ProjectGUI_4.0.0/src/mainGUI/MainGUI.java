...
public class MainGUI extends JPanel {
    ...
    public MainGUI() {
        ...
        //setBackground(Color.decode("#17191c"));
    ...
    private static void createAndShowGui() {
        ...
        //frame.getContentPane().setBackground(Color.decode("#17191c"));
        frame.setVisible(true);
    }

    /*
    public static void leaderboardSetup() {
        LeaderboardDB ldb = new LeaderboardDB();
        ldb.displayLeaderboard();
        ldb.getSortleaderboardRecord();
        Iterator<Map.Entry<String, Integer>> iterator = ldb.getSortleaderboardRecord().entrySet().iterator();
        int counter = 0;
