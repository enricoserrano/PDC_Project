...
public class ResultScreen extends JPanel {
    ...
    public ResultScreen(final MainGUI mainGui) {
        ...
        displayName.setFont(displayName.getFont().deriveFont(100.0f));
        displayScore.setFont(displayName.getFont().deriveFont(100.0f));
        ...
        OK.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println(LoginVariables.getUserName());
